...
def write_to_csv(results, filename):
    ...
    # COMPLETED: Write the results to a CSV file, following the specification in the instructions.
...
def write_to_json(results, filename):
    ...
    :param filename: A Path-like object pointing to where the data should be saved.
    """
    # COMPLETED: Write the results to a JSON file, following the specification in the instructions.
    data = []
    for approach in results:
